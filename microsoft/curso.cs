...
// Métodos
    ...
    // Método sobrecaregado é quando pode-se passar diversos tipos de valores por parâmetro
    Random dice = new Random();
    int roll1 = dice.Next(); // Sem limite
    int roll2 = dice.Next(101); // Limite superior
    int roll3 = dice.Next(50, 101); // Intervalo de valores
...
// Desafio
    // Achar o maior valor entre as variáveis
    int firstValue = 500;
    int secondValue = 600;
    int largerValue;
...
// Matrizes
    ...
    */
    ...
    // For each na matriz, com contador e acumulador
